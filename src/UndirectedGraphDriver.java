...
public class UndirectedGraphDriver {
    ...
    public static void main(String[] args){
        ...
        System.out.println(graph.numShortestPaths(1,2));
        //this should return a print statement of the toString of the graph generated by createTestGraph()
        UndirectedGraph graph2 = UndirectedGraphDriver.createTestGraph(7);
        System.out.println(graph2.toString());
        System.out.println(graph2.numShortestPaths(0,4));
    }
